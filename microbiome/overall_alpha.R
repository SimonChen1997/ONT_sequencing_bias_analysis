...
by(alpha_meta_dna_kit$Shannon, alpha_meta_dna_kit$extraction_kit, shapiro.test)
...
by(alpha_meta_basecall$Shannon, alpha_meta_basecall$basecall_mode, shapiro.test)
